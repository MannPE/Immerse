...
@Component({
  tag: 'translation-main-view',
  styleUrl: 'translation-main-view.scss'
})
export class TrnaslationMainApp {
  elements = [
    'site-header',
    'site-menu',
    'app-burger',
          ...
          <div class="container">
            <stencil-router scrollTopOffset={0}>
              <stencil-route-switch>
                <stencil-route url="/words" component="translate-words-page" />
                <stencil-route url="/pwa" component="pwas-page" />
                <stencil-route component="main-page" />
              </stencil-route-switch>
            </stencil-router>
          </div>
          <footer>
