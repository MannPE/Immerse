...
function createRendererPatch(plt, domApi) {
    ...
    function createElm(oldParentVNode, newParentVNode, childIndex, parentElm, i, elm, childNode, newVNode, oldVNode) {
        ...
        if (isDef(newVNode.vtext)) {
            ...
            elm = newVNode.elm = ((__BUILD_CONDITIONALS__.hasSvg && (isSvgMode || newVNode.vtag === 'svg')) ?
                ...
                domApi.$createElement((__BUILD_CONDITIONALS__.slotPolyfill && newVNode.isSlotFallback) ? 'slot-fb' : newVNode.vtag));
            ...
            if (newVNode.vchildren) {
                for (i = 0; i < newVNode.vchildren.length; ++i) {
                    ...
                    if (childNode) {
                        if (__BUILD_CONDITIONALS__.ssrServerSide && isDef(ssrId) && childNode.nodeType === 3 /* TextNode */ && !childNode['s-cr']) {
    ...
    function patchVNode(oldVNode, newVNode, defaultHolder) {
        ...
        else if (__BUILD_CONDITIONALS__.slotPolyfill && (defaultHolder = (elm['s-cr'] || elm['$defaultHolder'] /* $defaultHolder deprecated 2018-04-02 */))) {
...
function createPlatformMain(namespace, Context, win, doc, resourcesUrl, hydratedCssClass) {
    ...
    function requestBundle(cmpMeta, elm, hmrVersionId) {
        if (cmpMeta.componentConstructor) {
            ...
            const moduleOpts = {
                mode: elm.mode,
                scoped: cmpMeta.encapsulationMeta === 2 /* ScopedCss */ || (cmpMeta.encapsulationMeta === 1 /* ShadowDom */ && !domApi.$supportsShadowDom)
            };
            ...
            const useScopedCss = cmpMeta.encapsulationMeta === 2 /* ScopedCss */ || (cmpMeta.encapsulationMeta === 1 /* ShadowDom */ && !domApi.$supportsShadowDom);
...
function createPlatformMainLegacy(namespace, Context, win, doc, resourcesUrl, hydratedCssClass, customStyle) {
    ...
    function requestComponentBundle(cmpMeta, bundleId, hmrVersionId) {
        ...
        const useScoped = cmpMeta.encapsulationMeta === 2 /* ScopedCss */ || (cmpMeta.encapsulationMeta === 1 /* ShadowDom */ && !domApi.$supportsShadowDom);
