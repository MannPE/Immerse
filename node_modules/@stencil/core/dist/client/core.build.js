...
function attachStyles(plt, domApi, cmpMeta, hostElm) {
    ...
    const shouldScopeCss = (encapsulation === 2 /* ScopedCss */ || (encapsulation === 1 /* ShadowDom */ && !plt.domApi.$supportsShadowDom));
...
function initHostSnapshot(domApi, cmpMeta, hostElm, hostSnapshot, attribName) {
    ...
    {
        if (cmpMeta.encapsulation === 1 /* ShadowDom */ && domApi.$supportsShadowDom && !hostElm.shadowRoot) {
