...
function getEditors() {
    return __awaiter$2(this, void 0, void 0, function* () {
        ...
        try {
            const oie = require(openInEditorPath);
            yield Promise.all(Object.keys(oie.editors).map((id) => __awaiter$2(this, void 0, void 0, function* () {
...
function getDirectoryItems(fs$$1, filePath, urlPathName, dirItemNames) {
    return __awaiter$4(this, void 0, void 0, function* () {
        const items = yield Promise.all(dirItemNames.map((dirItemName) => __awaiter$4(this, void 0, void 0, function* () {
