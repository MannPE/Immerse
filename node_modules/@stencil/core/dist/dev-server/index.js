...
function getDevServerClientUrl(devServerConfig) {
...
function getDevServerClientScript(devServerConfig) {
    const devServerClientUrl = getDevServerClientUrl(devServerConfig);
