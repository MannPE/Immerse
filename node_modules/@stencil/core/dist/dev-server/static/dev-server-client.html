...
var UNREGISTER_SW_URL = DEV_SERVER_URL + "-init";
...
function appError(win, doc, config, buildResults) {
    ...
    buildResults.diagnostics.forEach(function (diagnostic) {
...
})(window.parent, window.parent.document, __DEV_CLIENT_CONFIG__);
</script>