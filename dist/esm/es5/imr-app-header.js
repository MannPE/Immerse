...
var AppHeader = /** @class */ (function () {
    ...
    AppHeader.prototype.render = function () {
        var _this = this;
        return (h("div", { class: "container" }, h("div", { class: "header-menu" }, h("stencil-route-link", { url: "/words", exact: true, onClick: function () { _this.hideNav(); } }, "My Words"), h("stencil-route-link", { url: "/pwa", exact: true, onClick: function () { _this.hideNav(); } }, "Settings"), h("stencil-route-link", { url: "/resources", exact: true, onClick: function () { _this.hideNav(); } }, "Immerse"), h("a", { class: "link--external", target: "_blank", href: "https://github.com/ionic-team/stencil" }, "GitHub ", h("app-icon", { name: "targetblank" })), h("div", { class: "header-close", onClick: function () { _this.hideNav(); } }, h("app-icon", { name: "close" }))), h("div", { class: "header-overflow", onClick: function (e) { _this.showNav(e); } }, h("app-icon", { name: "more" }))));
    };
