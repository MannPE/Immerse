...
var AppHeader = /** @class */ (function () {
    ...
    AppHeader.prototype.render = function () {
        var _this = this;
        return (h("div", { class: "container" }, h("div", { class: "header-menu" }, h("stencil-route-link", { url: "/", exact: true, onClick: function () { _this.hideNav(); } }, "Immerse"), h("stencil-route-link", { url: "/words", exact: true, onClick: function () { _this.hideNav(); } }, "Words"), h("stencil-route-link", { url: "/settings", exact: true, onClick: function () { _this.hideNav(); } }, "Settings"))));
    };
    ...
    AppRoot.prototype.render = function () {
        return [
            ...
            h("div", { class: "root" }, h("div", { class: "container" }, h("stencil-router", null, h("stencil-route", { routeRender: function (props) {
                ...
                } }))), ",", h("footer", null, h("div", { class: "container" }, h("div", { class: "footer__open-source" }, h("p", null, "Made by Manuel Puentes @2018"), h("a", { class: "link--external", target: "_blank", href: "https://paypal.com" }, "Donate ", h("app-icon", { name: "targetblank" }))), h("div", { class: "footer__icons" }, h("a", { class: "svg-button", id: "stencil-twitter", href: "https://twitter.com/stenciljs", target: "_blank", rel: "noopener", title: "Follow me on " }, h("app-icon", { name: "twitter" })), h("a", { class: "svg-button", id: "ionic-forum", href: "https://stencil-worldwide.herokuapp.com", target: "_blank", rel: "noopener", title: "Join the stencil worldwide slack" }, h("app-icon", { name: "slack" }))))))
        ];
    };
...
var Route = /** @class */ (function () {
    ...
    Route.prototype.componentDidUpdate = function () {
        ...
        Promise.all(Array.from(this.el.children).map(function (element) {
            ...
            else if (_this.match && !matchesAreEqual(_this.match, _this.previousMatch)) {
