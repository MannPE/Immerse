...
class TranslateHeader {
    ...
    render() {
        return (h("div", { class: "container" },
            h("stencil-route-link", { url: "/", class: "logo-link" },
                h("img", { class: "logo", alt: "Placeholder", src: "/assets/img/stencil-logo-new.svg" })),
            h("div", { class: "header-menu" },
                ...
                h("stencil-route-link", { url: "/resources", exact: true, onClick: () => { this.hideNav(); } }, "Donate"),
    ...
    static get is() { return "translate-header"; }
...
class TrnaslationMainApp {
    ...
    render() {
        ...
        return (h(SiteProviderConsumer.Provider, { state: siteState },
            h("translate-header", null),
            h("div", { class: "root" },
                h("div", { class: "container" },
                    h("stencil-router", { scrollTopOffset: 0 },
                        h("stencil-route-switch", null,
                            h("stencil-route", { url: "/words", component: "translate-words-page" }),
                            h("stencil-route", { url: "/pwa", component: "pwas-page" }),
                            h("stencil-route", { component: "main-page" })))),
                h("footer", null,
                    h("div", { class: "container" },
                        ...
                        h("div", { class: "footer__icons" },
                            h("lazy-iframe", { class: 'star-button', src: 'https://ghbtns.com/github-btn.html?user=ionic-team&repo=stencil&type=star&count=true', frameBorder: '0', scrolling: '0', width: '100px', height: '20px' }),
    ...
    static get is() { return "translation-main-view"; }
    static get properties() { return {
        "el": {
            "elementRef": true
        },
...
export { TranslateHeader, TrnaslationMainApp as TranslationMainView, Route as StencilRoute, RouteSwitch as StencilRouteSwitch, Router as StencilRouter };
